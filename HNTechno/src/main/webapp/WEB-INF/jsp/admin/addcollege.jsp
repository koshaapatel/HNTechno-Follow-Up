                     	...
                     	<tr class="odd gradeX">
                            ...
                            <td>
                             ...
                             <td>
                            	 <table class="table table-striped table-bordered" >
                            	 	<c:forEach items="${v.clgd}" var="z" varStatus="count">
                            	 	<tr class="odd gradeX" id="trsl${z.clgdid}">
                        				<td id="tdsl${z.clgdid}">
                            				<span id="sl${z.clgdid}">${z.clgname}</span>
                           				 </td>
                           				 <%-- <td id="tdbtn${z.clgdid}">
                            				<div class="btn-group pull-right">
                                				<button type="button" id="btn${z.clgdid}" class="btn btn-success active" data-toggle="dropdown"><i class="fa fa-pencil"></i></button>
                                    				<ul class="dropdown-menu" role="menu">
				                       				 	<li><a href="#modal-alert-delete1" onclick="deletedata(${z.clgdid})" data-toggle="modal">Delete</a></li>
				                        				<li onclick="update(${z.clgdid},'${z.clgname}')"><a href="#">Edit</a></li>
				                        			</ul>
				                			 </div>
                            			 </td> --%>
                           			</tr>
                            ...
                            <div class="btn-group pull-right">
                                <button type="button" class="btn btn-success active" data-toggle="dropdown"><i class="fa fa-pencil"></i></button>
                                    <ul class="dropdown-menu" role="menu">
				                       	<li><a href="#modal-alert-delete" onclick="deleted(${v.clgmid})" data-toggle="modal">Delete</a></li>
				                       	<li><a href="#modal-dialog${v.clgmid}" data-toggle="modal">Edit</a></li>
				                       	<li><a href="#modal-alert-remove" onclick="remove(${v.clgmid})" data-toggle="modal">Remove</a></li>
				                    </ul>
				             </div>
                             </td> --%>
                         </tr>
					...
					<div class="panel-body">
						 <div class="form-group">
            	            <label class="col-md-3 control-label">University *</label>
                            	<div class="col-md-9">
                        	        <form:select path="u.umid" class="form-control">
                        	        	  <form:option value="0">Select University</form:option>
                    	                <c:forEach items="${list1}" var="v">
                    	                	<form:option value="${v.umid}">${v.uname}</form:option>
                    	                </c:forEach>
									</form:select>
                                 </div>
	                     </div>
