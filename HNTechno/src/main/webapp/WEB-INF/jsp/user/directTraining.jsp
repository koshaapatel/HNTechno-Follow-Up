				...
				<div class="grid-col grid-col-9">
					...
					<div role="main">
						<div  itemscope="" itemtype="http://schema.org/Product" class="product">
							<div class="images">
								<div class="picture">
									<img src="pic/shop/370x370-img-1.jpg" data-at2x="pic/shop/370x370-img-1@2x.jpg" class="attachment-shop_single" alt="" title="">
									<div class="hover-effect"></div>
									<div class="link-cont">
										<a href="pic/shop/370x370-img-1@2x.jpg" class="fancy fa fa-eye woocommerce-main-image zoom" data-fancybox-group="gallery" title="" data-rel="prettyPhoto[product-gallery]"></a>
									</div>
								</div>
								<div class="thumbnails">
									<div class="owl-carousel">
										<div class="pic thumbnail">
											<a href="pic/shop/116x116-img-1@2x.jpg" class="zoom first fancy" data-fancybox-group="gallery" title="" data-rel="prettyPhoto[product-gallery]">
												<div class="hover-effect"></div>
												<img src="pic/shop/116x116-img-1.jpg" data-at2x="pic/shop/116x116-img-1@2x.jpg" class="attachment-shop_thumbnail" alt="">
											</a>
										</div>
										<div class="pic thumbnail">
											<a href="pic/shop/116x116-img-2@2x.jpg" class="zoom first fancy" data-fancybox-group="gallery" title="" data-rel="prettyPhoto[product-gallery]">
												<div class="hover-effect"></div>
												<img src="pic/shop/116x116-img-2.jpg" data-at2x="pic/shop/116x116-img-2@2x.jpg" class="attachment-shop_thumbnail" alt="">
											</a>
										</div>
										<div class="pic thumbnail">
											<a href="pic/shop/116x116-img-3@2x.jpg" class="zoom first fancy" data-fancybox-group="gallery" title="" data-rel="prettyPhoto[product-gallery]">
												<div class="hover-effect"></div>
												<img src="pic/shop/116x116-img-3.jpg" data-at2x="pic/shop/116x116-img-3@2x.jpg" class="attachment-shop_thumbnail" alt="">
											</a>
										</div>
										<div class="pic thumbnail">
											<a href="pic/shop/116x116-img-1@2x.jpg" class="zoom first fancy" data-fancybox-group="gallery" title="" data-rel="prettyPhoto[product-gallery]">
							...
							<div class="summary entry-summary">
								<h2  class="product_title entry-title">Kraftout Doodlepad</h2>
							...
							<div class="tabs">
								<div class="block-tabs-btn clear-fix">
									...
									<div class="tabs-btn" data-tabs-id="tabs2">Additional Information</div>
									<div class="tabs-btn" data-tabs-id="tabs3">Reviews (2)</div>
								</div>
								<!-- tabs keeper -->
								<div class="tabs-keeper">
									<!-- tabs container -->
									<div class="container-tabs active" data-tabs-id="cont-tabs1">
										<p><strong>Donec vitae sapien ut libero venenatis faucibus.</strong></p><p>Maecenas accumsan, massa nec vulputate congue, dolor erat ullamcorper dolor, ac aliquam eros sem in dui. In eu sagittis metus. Proin consectetur suscipit dui sed euismod. Nam non metus in est vehicula vestibulum et vel neque. Mauris scelerisque lectus at diam pretium, eget fringilla erat sollicitudin.</p>
										<p>Pellentesque quis pharetra tellus. Donec interdum nisi at sem ornare, ut congue felis eleifend. Nam elementum nec leo eget pharetra. Quisque consectetur porta erat sit amet fermentum.</p>
									...
									<div class="container-tabs" data-tabs-id="cont-tabs3">
										<div id="reviews">
											<div class="comments">
												<h3>2 Reviews for Kitchen</h3>
												<ol class="commentlist">
													<li class="comment">
														<div class="comment_container clear">
															<img src="pic/70x70-img-2.jpg" data-at2x="pic/70x70-img-2@2x.jpg" alt="" class="avatar">
															<div class="comment-text">
																...
																<p class="meta">
																	...
																	<time itemprop="datePublished" datetime="2016-06-07T12:14:53+00:00">/ 2015.06.25 12:12:14</time>
																</p>
													...
													<li class="comment">
														<div class="comment_container clear">
															<img src="pic/70x70-img-3.jpg" data-at2x="pic/70x70-img-3@2x.jpg" alt="" class="avatar">
															<div class="comment-text">
																<div class="star-rating" title="Rated 5.00 out of 5">
																	<span style="width:80%"><strong class="rating">4.00</strong> out of 5</span>
																</div>
																<p class="meta">
																	<strong>Joss Doe</strong>
												...
												<div id="review_form">
													<div id="respond" class="comment-respond">
														...
														<form class="comment-form">
															...
															<p class="form-submit">
																<a href="#" class="cws-button border-radius small">Submit</a>
															</p>
														</form>
													</div>
												</div>
										...
										<div class="owl-carousel owl-three-item">
											<div class="gallery-item">
												...
												<div class="product new">
													<div class="picture">
														<img src="pic/shop/270x200-img-3.jpg" data-at2x="pic/shop/270x200-img-3@2x.jpg" alt="">
														<span class="hover-effect"></span>
														<div class="link-cont">
															<a href="pic/shop/270x200-img-8@2x.jpg" class="cws-right fancy cws-slide-left "><i class="fa fa-search"></i></a>
											...
											<div class="gallery-item">
												...
												<div class="product new">
													<div class="picture">
														<img src="pic/shop/270x200-img-4.jpg" data-at2x="pic/shop/270x200-img-4@2x.jpg" alt="">
														<span class="hover-effect"></span>
														<div class="link-cont">
															<a href="pic/shop/270x200-img-4@2x.jpg" class="cws-right fancy cws-slide-left "><i class="fa fa-search"></i></a>
															<a href="shop-single-product.html" class=" cws-left cws-slide-right"><i class="fa fa-link"></i></a>
														</div>
											...
											<div class="gallery-item">
												...
												<div class="product new">
													<div class="picture">
														<img src="pic/shop/270x200-img-5.jpg" data-at2x="pic/shop/270x200-img-5@2x.jpg" alt="">
														<span class="hover-effect"></span>
														<div class="link-cont">
															<a href="pic/shop/270x200-img-5@2x.jpg" class="cws-right fancy cws-slide-left "><i class="fa fa-search"></i></a>
															<a href="shop-single-product.html" class=" cws-left cws-slide-right"><i class="fa fa-link"></i></a>
														</div>
											...
											<div class="gallery-item">
												...
												<div class="product new">
													<div class="picture">
														...
														<span class="hover-effect"></span>
														<div class="link-cont">
															<a href="pic/shop/270x200-img-3@2x.jpg" class="cws-right fancy cws-slide-left "><i class="fa fa-search"></i></a>
															<a href="shop-single-product.html" class=" cws-left cws-slide-right"><i class="fa fa-link"></i></a>
														</div>
											...
											<div class="gallery-item">
												...
												<div class="product new">
													<div class="picture">
														<img src="pic/shop/270x200-img-1.jpg" data-at2x="pic/shop/270x200-img-1@2x.jpg" alt="">
														<span class="hover-effect"></span>
														<div class="link-cont">
															<a href="pic/shop/270x200-img-8@2x.jpg" class="cws-right fancy cws-slide-left "><i class="fa fa-search"></i></a>
															<a href="shop-single-product.html" class=" cws-left cws-slide-right"><i class="fa fa-link"></i></a>
					...
					<aside class="widget">
						...
						<div class="widget_shopping_cart_content">
							<ul class="cart_list product_list_widget">
								<li>
									<a href="#">
										<img src="pic/65x65-img-1.jpg" data-at2x="pic/65x65-img-1@2x.jpg" alt="Placeholder" width="90" class="woocommerce-placeholder wp-post-image" height="90">
